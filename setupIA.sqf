...
asr_ai3_main_sets = [ // for each level: skilltype, [<min value>, <random value added to min>]
	...
	[	"general",[0.80,0.2],	"aiming",[0.50,0.2],	"spotting",[0.50,0.1]	],	// 1:  sf 1
	[	"general",[0.70,0.2],	"aiming",[0.40,0.2],	"spotting",[0.40,0.1]	],	// 2:  sf 2 (recon units, divers and spotters)
	[	"general",[0.60,0.2],	"aiming",[0.25,0.1],	"spotting",[0.30,0.1]	],	// 3:  regular 1 (regular army leaders, marksmen)
	[	"general",[0.50,0.2],	"aiming",[0.20,0.1],	"spotting",[0.10,0.1]	],	// 4:  regular 2 (regulars)
	...
	[	"general",[0.60,0.2],	"aiming",[0.20,0.1],	"spotting",[0.35,0.1]	],	// 8:  pilot 1 (regular)
	[	"general",[0.50,0.2],	"aiming",[0.15,0.1],	"spotting",[0.30,0.1]	],	// 9:  pilot 2 (insurgent)
