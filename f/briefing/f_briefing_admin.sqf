...
// Test AISkill+
_briefing = _briefing + "
<font size='18'>AISkill+</font><br/>
|- <execute expression=""[[[],'f\AISKILL\skillNOOB.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'AISKillPLUS lancé!';"">
Skill noob pour debug</execute><br/>
|- <execute expression=""[[[],'f\AISKILL\skillLOW.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'AISKillPLUS lancé!';"">
Skill tres faible recrue</execute><br/>
|- <execute expression=""[[[],'f\AISKILL\skillREBELLOW.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'AISKillPLUS lancé!';"">
Skill faible rebels et milices</execute><br/>
|- <execute expression=""[[[],'f\AISKILL\skillREGULARFAIR.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'AISKillPLUS lancé!';"">
Skill normal et juste</execute><br/>
|- <execute expression=""[[[],'f\AISKILL\skillSOLDATELITE.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'AISKillPLUS lancé!';"">
Skill soldat elite</execute><br/>
|- <execute expression=""[[[],'f\AISKILL\skillSPECOPS.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'AISKillPLUS lancé!';"">
Skill SPECOPS Tueur!</execute><br/>
";
...
|- <execute expression=""[[[],'f\Side\indefrbl.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'Les indépendants et les BLUFOR sont maintenant amis.';"">
Allier Inde et BLUFOR</execute><br/>

|- <execute expression=""[[[],'f\Side\indenbl.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'Les indépendants et les BLUFOR sont maintenant ennemis.';"">
Rendre Inde et BLUFOR ennemis</execute><br/>

|- <execute expression=""[[[],'f\Side\indefrop.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
hintsilent 'Les indépendants et les OPFOR sont maintenant alliés.';"">
Allier Inde et OPFOR</execute><br/>

|- <execute expression=""[[[],'f\Side\indeenop.sqf'],'BIS_fnc_execVM',true]  call BIS_fnc_MP;
